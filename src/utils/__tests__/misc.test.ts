import { extractSampleInput } from '../misc';

const year2024day7Problem = `
...
const year2024day7Sample = `190: 10 19
3267: 81 40 27
83: 17 5
156: 15 6
7290: 6 8 6 15
...
describe('extractSampleInput', () => {
  it('should extract sample input from the HTML of year 2024 day 7 problem', () => {
    const result = extractSampleInput(year2024day7Problem);
    expect(result).toBe(year2024day7Sample);
  });
});
